...
var Tweener = /*#__PURE__*/function () {
  ...
  function Tweener() {
    ...
    if (JSON.stringify(opt) !== JSON.stringify(defaultOptions)) {
      ...
      this.data.push(_objectSpread(_objectSpread({}, opt), {}, {
        onStart: onStart
      }));
    }
  ...
  _createClass(Tweener, [{
    ...
    value: function render() {
      ...
      if (currentTime < duration) {
        // keep render
        onUpdate === null || onUpdate === void 0 ? void 0 : onUpdate(_objectSpread(_objectSpread({}, this.defaultFrom), result));
        ...
        if (this.enable) {
          ...
          // force stop
          this.result = _objectSpread(_objectSpread(_objectSpread({}, this.defaultFrom), from), result);
        ...
        this.result = _objectSpread(_objectSpread(_objectSpread({}, this.defaultFrom), from), result); // remove queue

        this.data.shift();
        onComplete === null || onComplete === void 0 ? void 0 : onComplete(_objectSpread(_objectSpread({}, this.defaultFrom), to)); // check data. run next queue when data still has one
