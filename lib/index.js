  ...
  _createClass(Tweener, [{
    ...
    value: function render() {
      ...
      if (currentTime < duration) {
        // keep render
        onUpdate === null || onUpdate === void 0 ? void 0 : onUpdate(_objectSpread(_objectSpread({}, this.result), result));
        ...
        this.result = _objectSpread(_objectSpread({}, this.result), to); // remove queue
