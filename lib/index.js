...
var Tweener = /*#__PURE__*/function () {
  ...
  function Tweener() {
    ...
    if (JSON.stringify(opt) !== JSON.stringify(defaultOptions)) {
      var method = options.onStart || function () {};

      var onStart = {
        method: method,
        is: false
      };
      this.data.push(_objectSpread(_objectSpread({}, options), {}, {
        onStart: onStart
      }));
      this.play();
    }
  ...
  _createClass(Tweener, [{
    key: "add",
    value: function add() {
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultAddOptions;

      var opt = _objectSpread(_objectSpread({}, defaultAddOptions), options);
